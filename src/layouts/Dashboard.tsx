  ...
  return (
    <main className="h-[calc(100vh-60px)] p-4 text-black dark:bg-night-bg dark:text-white">
      <div className="mx-auto max-w-screen-2xl">
        ...
        {showInput ? (
          <form className="mt-4 flex max-w-[300px] flex-col gap-2 rounded-md border p-4 dark:border-night-border">
            <input
          ...
          <button
            ...
            className="mt-4 flex w-[300px] items-center gap-2 rounded-md border  bg-white px-4 py-2 text-sm  font-semibold  shadow-sm hover:bg-hover dark:border-night-border dark:bg-night-bg dark:text-night-gray-text dark:hover:bg-night-nav"
          >
